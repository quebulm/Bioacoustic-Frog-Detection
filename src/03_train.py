...
# ------------------------------
# 0️⃣ Hyperparameter oben definieren
# ------------------------------
ALPHA = 0.6065373178059441
GAMMA = 2.883417736772443
LEARNING_RATE = 0.0002315753655529834
THRESHOLD = 0.6370034510843516
POS_WEIGHT = 3.5756322700942427
...
MODEL_SAVE_PATH = "../models/frog_call_classifier_v0_3"
...
def build_classifier():
    model = keras.Sequential([
        layers.Input(shape=(1024,)),  # Eingabe: YAMNet-Embeddings (1024,)
        ...
        layers.Dense(1, activation="sigmoid")  # Binäre Klassifikation (Froschruf oder nicht)
    ])
